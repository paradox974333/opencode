...
const productName = channel === "prod" ? "Sally Code" : `Sally Code ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      Sally Code is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
