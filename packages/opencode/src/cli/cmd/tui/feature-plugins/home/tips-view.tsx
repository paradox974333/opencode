...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent Sally Code from reading sensitive files",
  "Use {highlight}sallycode run{/highlight} for non-interactive scripting",
  "Use {highlight}sallycode --continue{/highlight} to resume the last session",
  "Use {highlight}sallycode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}sallycode serve{/highlight} for headless API access to Sally Code",
  "Use {highlight}sallycode run --attach{/highlight} to connect to a running server",
  "Run {highlight}sallycode upgrade{/highlight} to update to the latest version",
  "Run {highlight}sallycode auth list{/highlight} to see all configured providers",
  "Run {highlight}sallycode agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}sallycode github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}sallycode debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with Sally Code Zen for curated, tested models",
