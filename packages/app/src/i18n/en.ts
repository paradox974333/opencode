export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Sally Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Sally Code.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Sally Code Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Sally Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Sally Code.",
  ...
  "dialog.server.description": "Switch which Sally Code server this app connects to.",
  ...
  "toast.update.description": "A new version of Sally Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Sally Code team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Sally Code does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Sally Code includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Sally Code Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Sally Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Sally Code",
  ...
  "settings.general.row.appearance.description": "Customise how Sally Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Sally Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Sally Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Sally Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Sally Code.",
